...
function prep_group {
  ...
  genesis_root=$(cat ../../../../network-configs/devnet-2m-test/parsedBeaconState.json| jq -r .genesis_validators_root)
  genesis_version=$(cat ../../../../network-configs/devnet-2m-test/config.yaml| yq .GENESIS_FORK_VERSION)
